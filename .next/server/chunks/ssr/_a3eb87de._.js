...
"[project]/actions/data:285387 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$285387__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/actions/data:285387 [app-ssr] (ecmascript) <text/javascript>");
...
const Dashboard = ()=>{
    ...
    //
    const getData = async ()=>{
        let u = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$16576b__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["fetchuser"])(session.user.name);
        setform(u);
    };
    const handleSubmit = async (e)=>{
        e.preventDefault();
        update();
        let a = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$285387__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateProfile"])(session.user.name, form);
...
//# sourceMappingURL=_a3eb87de._.js.map