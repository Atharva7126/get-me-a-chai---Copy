                    ...
                    <div className="flex items-center justify-between py-2">
                        ...
                        <div className="sm:flex sm:items-center space-x-1 justify-end">
                            {session && <>
                                ...
                                }} onClick={() => setShowdropdown(!showdropdown)} className="text-white w-fit flex justify-center items-center cursor-pointer bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-2 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-4 py-2 text-center space-x-2"><Image className='rounded-full' unoptimized src={session.user.image} alt="" width={24} /> {session.user.name} <svg className="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
